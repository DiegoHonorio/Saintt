...
// Add "Sort by Category" option to WooCommerce sorting dropdown
add_filter('woocommerce_get_catalog_ordering_args', 'custom_sort_by_category');
add_filter('woocommerce_default_catalog_orderby_options', 'add_category_sorting_option');
add_filter('woocommerce_catalog_orderby', 'add_category_sorting_option');

function add_category_sorting_option($sortby) {
    $sortby['sort_by_category'] = 'Sort by Category';
    return $sortby;
}

function custom_sort_by_category($args) {
    if (isset($_GET['orderby']) && 'sort_by_category' === $_GET['orderby']) {
        $args['orderby'] = 'menu_order'; // Sort by WooCommerce's category order
        $args['order'] = 'ASC';
    }
    return $args;
}
